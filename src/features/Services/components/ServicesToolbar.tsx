...
function ServicesToolbarComponent({
  ...
  const visibleActiveFilters = activeFilters.slice(0, 5);
  ...
  const statsSummaryElement = (
    <div className="grid grid-cols-3 gap-2 rounded-md bg-white p-3 shadow-sm">
      ...
      <div>
        ...
        <strong className="text-lg text-secondary-900">{resultCount}</strong>
      </div>
      ...
      <div>
        ...
        <strong className="text-lg text-secondary-900">{totalCount}</strong>
      </div>
    </div>
  );
